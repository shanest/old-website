  ...
  slides.single_trial = slide({
    ...
    present_handle : function(stim) {
	    ...
	    function display_three(init_time) {
		    ...
		    true_text = exp.condition == "left arrow" ? "'left arrow'" : "'right arrow'";
		    false_text = exp.condition == "left arrow" ? "'right arrow'" : "'left arrow'";
		    $(".true_response").html("Press " + true_text + " for True.");
		    $(".true_response").show();
		    $(".false_response").html("Press " + false_text + " for False.");
		    $(".false_response").show();
